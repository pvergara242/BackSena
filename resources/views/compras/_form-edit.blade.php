...
<form class="formulario" action="{{ route('compra.update') }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PATCH')
...
<div class="container mb-5">
      ...
      <button class="btn btn-success float-right" type="submit">Actualizar Compra</button>
